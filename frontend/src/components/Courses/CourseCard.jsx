...
const CourseCard = ({ course, onSelect }) => {
  ...
  return (
    <div className="group relative bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden transform hover:-translate-y-1 h-full flex flex-col w-full max-w-sm min-w-[320px]">
      {/* Course Image */}

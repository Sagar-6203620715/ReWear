...
const Footer = () => {
  return (
    <footer className="border-t py-12 mt-6">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0">
        ...
        <div>
          <h3 className="text-lg text-gray-800 mb-4 ">Category</h3>
        ...
        <div>
          ...
          <div className="flex items-center space-x-4 mb-6">
            <a href="https://www.facebook.com" target="_blank" rel="noopener noreffer" className="hover:text-gray-500">
